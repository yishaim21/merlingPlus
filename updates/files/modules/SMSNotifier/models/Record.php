...
class SMSNotifier_Record_Model extends Vtiger_Record_Model {
	...
	public static function SendSMS($message,$sourceNumber, $toNumbers, $currentUserId, $recordIds, $moduleName) {
		SMSNotifier::sendsms($message,$sourceNumber, $toNumbers, $currentUserId, $recordIds, $moduleName);
	}
